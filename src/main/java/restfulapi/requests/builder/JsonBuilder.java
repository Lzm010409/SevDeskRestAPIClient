...
public class JsonBuilder {
    ...
    public String build(Voucher voucher, VoucherPosSave voucherPosSave, String creditDebit) throws Exception {
    ...
    public String build(Contact contact) throws Exception {
    ...
    public String build(ContactAddress contactAdress, data.entity.link.Contact contact) throws Exception {
    ...
    public String build(Tag tag) throws Exception {
        String input = gson.toJson(tag);
        return input;
    }

    public String build(Invoice invoice, List<InvoicePos> invoicePos) throws Exception {
